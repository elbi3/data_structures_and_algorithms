...
describe('sort', () => {
  ...
  it.todo('handles an array already sorted in ascending order');
  it.todo('sorts an array sorted in descending order');
  ...
  //  delete the it.todo lines as you replace them.
});